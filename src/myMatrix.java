...
public class myMatrix {
    ...
    public static void main(String[] args) {
        ...
        ds[1][1] = 5;
        m.fillRows(ds);
        ArrayList<String> e = m.eigenValues();
        System.out.println(e.toString());
        myMatrix matrix = matrixEigVector(m,2,e);
...
//		PLU.add(L);
    ...
    public static myMatrix matrixEigVector(myMatrix tm, int l, ArrayList<String> eigenValues) {
        double[][] tempMatrix = new double[l][l];
        for (int i = 0; i < l; i++) {
            tempMatrix[i][i] = Double.parseDouble(eigenValues.get(1));
        }
        for (int i = 0; i < l; i++) {
            for (int j = 0; j < l; j++) {
                if (i != j) {
        ...
        myMatrix temp = new myMatrix(l,l);
        temp.fillRows(tempMatrix);
        myMatrix m = tm.subtractMatrix(temp);
        return m.getInverse();
    }//Of matrixEigVector
